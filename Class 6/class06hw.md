...
```
    ...
    C:\Users\kavan\AppData\Local\Temp\Rtmpkd1cmH/4AKE.pdb exists. Skipping download
...
![](class06hw_files/figure-commonmark/unnamed-chunk-5-1.png)
    ...
    Warning in get.pdb(file, path = tempdir(), verbose = FALSE):
    C:\Users\kavan\AppData\Local\Temp\Rtmpkd1cmH/1AKE.pdb exists. Skipping download
...
![](class06hw_files/figure-commonmark/unnamed-chunk-5-2.png)
    ...
    Warning in get.pdb(file, path = tempdir(), verbose = FALSE):
    C:\Users\kavan\AppData\Local\Temp\Rtmpkd1cmH/1E4Y.pdb exists. Skipping download
